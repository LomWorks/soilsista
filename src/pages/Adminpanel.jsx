...
const ADMIN_EMAIL = process.env.REACT_APP_ADMIN_EMAIL || "info@soilsista.org";
...
export default function AdminPanel() {
  ...
  // Firebase Auth — only allow the admin email
      ...
      <div style={styles.loginContainer}>
        ...
        >
          ...
          <p style={styles.loginSubtitle}>
            You must be signed in as <strong>{ADMIN_EMAIL}</strong> to access this page.
          </p>
          <p style={{ color: "#999", fontSize: "0.85rem", marginTop: "1rem" }}>
            Sign in via the main login page and return here.
          </p>
        </motion.div>
      </div>
    );
